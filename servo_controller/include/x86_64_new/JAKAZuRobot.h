...
public:
	...
	*/
	errno_t login_in(const char *ip, int edgStatPort);
	...
	* @brief 回零
	* @param servo_home
	* @param joint  关节序号，0 for 关节1，1 for 关节 2 ...
	* @return ERR_SUCC 成功 其他失败
	*/
	errno_t servo_home(int joint);
    ...
    errno_t robot_add_ftsensor(int robot_id, int sensor_id);
